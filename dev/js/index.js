...
function loaderCompleted() {
    ...
    $("#page5 .btnM1").tap(function () {
        showSlider({
            pics: ["../img/p5-detail3-1.png", "../img/p5-detail3-2.jpg"],
            width: "14.025rem",
            height: "13.175rem",
            animateType: "fade"
        });
    ...
    $("#page5 .btnM2").tap(function () {
        showSlider({
            pics: ["../img/p5-detail1-2.jpg", "../img/p5-detail1-1.jpg"],
            width: "14.025rem",
            height: "17.925rem",
            animateType: "fade"
        });
    ...
    $("#page5 .btnM3").tap(function () {
        showSlider({
            ...
            pics: ["../img/p5-detail2-1.jpg", "../img/p5-detail2-2.jpg", "../img/p5-detail2-3.jpg"],
            width: "13.3rem",
            height: "8.45rem",
            top: "0.3625rem",
            left: "0.3625rem",
    ...
    $("#page7 .btnM1").on("touchstart", function () {
        showSlider({
            pics: ["../img/p7-detail1.jpg", "../img/p7-detail2.jpg"],
            width: "14.025rem",
            height: "10.35rem",
            animateType: "default",
            dot: true,
